...
class ism_data(object):
    ...
    def next_batch(self):
        ...
        label_batch = list(map(lambda x: x[1:3], sample_logit_labels))
        logit_batch = list(map(lambda x: x[3:], sample_logit_labels))
    ...
    def validation_set(self):
        ...
        all_label = list(map(lambda x: x[1:3], all_logit_and_labels))
        all_logit = list(map(lambda x: x[3:], all_logit_and_labels))
