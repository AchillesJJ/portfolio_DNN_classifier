...
ism_input = './ismdatabak_validation/ismlist.20180404.6.7.567.1100'
f = open('./ismdatabak_validation/ismlist.20180404.6.7.567.1100', 'r')
cnt = 0
data = []
for line in f:
    cnt += 1
...
# ls = os.path.split('./ismdatabak_validation/ismlist.20180404.6.7.567.1000')
# x = ls[-1].split('.')[-1]
# print(x)
# 
# ism = ism_data('./ismdatabak_validation', 7)
