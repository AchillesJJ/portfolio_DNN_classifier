...
class ISMClassifier(object):
    ...
    def evaluate(self, inputs, ismcode):
...
def main(args):
    ...
    with tf.Session() as sess:
        ...
        # training mode
        if args.mode == 0:
            logger.info('dense encoding DNN classifier, training mode begins ...')
        ...
        # validation mode
            ...
            logger.info('dense encoding DNN classifier, validation mode begins ...')
