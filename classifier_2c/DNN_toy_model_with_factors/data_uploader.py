...
class exporter(object):
    ...
    def data_upload(self):
        ...
        flag1 = "ssh " + self.user + "@" + self.IP + " mkdir " + \
                os.path.join(self.cp, '2c_factors')
        flag2 = "scp -r " + os.path.join(self.lfp, '*ismlist.[0-9]*') + " " + self.user + \
                "@" + self.IP + ":" + os.path.join(self.cp, '2c_factors')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-cp', '--cd-path', help='path to upload data', default='/data/filter_ismcom_test')
